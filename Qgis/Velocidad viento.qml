...
<qgis version="3.34.1-Prizren" maxScale="0" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" minScale="1e+08">
  ...
  <elevation zscale="1" zoffset="0" band="1" enabled="0" symbology="Line">
    ...
    <profileLineSymbol>
      <symbol alpha="1" type="line" name="" clip_to_extent="1" is_animated="0" force_rhr="0" frame_rate="10">
        ...
        <layer locked="0" enabled="1" class="SimpleLine" pass="0" id="{0d0f5620-bae1-4000-9e7a-65c21d6dfa93}">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol alpha="1" type="fill" name="" clip_to_extent="1" is_animated="0" force_rhr="0" frame_rate="10">
        ...
        <layer locked="0" enabled="1" class="SimpleFill" pass="0" id="{b9b0bad1-3c65-4ecf-8404-25c96066501b}">
          <Option type="Map">
  ...
  <pipe>
    ...
    <rasterrenderer type="singlebandpseudocolor" nodataColor="" classificationMin="0" band="1" opacity="1" alphaBand="-1" classificationMax="10">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
      ...
      <rastershader>
        <colorrampshader classificationMode="2" maximumValue="10" minimumValue="0" colorRampType="DISCRETE" labelPrecision="0" clip="0">
          ...
          <item alpha="255" label="&lt;= 1" color="#2b83ba" value="1"/>
          <item alpha="255" label="1 - 2" color="#64abb0" value="2"/>
          <item alpha="255" label="2 - 3" color="#9dd3a6" value="3"/>
          <item alpha="255" label="3 - 4" color="#c7e8ad" value="4"/>
          <item alpha="255" label="4 - 5" color="#ecf7b9" value="5"/>
          <item alpha="255" label="5 - 6" color="#ffedaa" value="6"/>
          <item alpha="255" label="6 - 7" color="#fec980" value="7"/>
          <item alpha="255" label="7 - 8" color="#f99d59" value="8"/>
          <item alpha="255" label="8 - 9" color="#e85b3b" value="9"/>
          <item alpha="255" label="> 9" color="#d7191c" value="inf"/>
          <rampLegendSettings direction="0" maximumLabel="" orientation="1" useContinuousLegend="1" minimumLabel="" suffix="" prefix="">
